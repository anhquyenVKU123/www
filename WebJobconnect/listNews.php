            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn text-white" href="/home/danh-sach-tin-tuc/">Danh sách tin tức</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="bg-light mb-4 w-100 h-100 shadow border border-primary">
                            <div class="position-relative">
                                ...
                                <a href="/home/danh-sach-tin-tuc/noi-dung/<?php echo $row['IDNews']; ?>" class="position-absolute w-100 h-100 d-flex flex-column align-items-center justify-content-center   text-decoration-none p-4" style="top: 0; left: 0; background: rgba(0, 0, 0, .4);">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                        ...
                        <div class="d-flex flex-column pl-3">
                            <a class="text-dark mb-2" href="/home/danh-sach-tin-tuc/noi-dung/<?php echo $rownews['IDNews']; ?>"><?php echo $rownews['Tieude']; ?></a>
                            <div class="d-flex">
