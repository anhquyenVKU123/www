<?php
    ...
    $sql = "SELECT emp.NameCompany,emp.Avatar,tin.MucLuong,tin.Vitri,tin.Nganh,hs.*
                ...
                WHERE hs.IDEmployer='".$_SESSION['id_employer']."'";
...
<body>
    ...
    <div class="container-fluid d-flex align-content-center justify-content-center py-2">
        <form action="/Employer/home/danh-sach-don-ung-tuyen" id="bolocForm" method="POST">
            <div class="row">
                <div class="col-md-3 d-flex justify-content-center">
                    ...
                    <select name="city" id="" class="btn btn-primary rounded-pill my-2">
                        ...
                        <option class="text-left" value="<?php echo $rowcity['TenTinhthanh']; ?>"><?php echo  $rowcity['TenTinhthanh']; ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="col-md-3 d-flex justify-content-center">
                ...
                <div class="col-md-3 d-flex justify-content-center">
                    <select name="nameSchool" id="" class="btn btn-primary rounded-pill my-2">
                        <option value="">Trường Đại học</option>
                        <?php 
                            $sqlschool = "SELECT * FROM truongdaihoc ORDER BY IDTinhthanh ASC";
                            $resschool = mysqli_query($conn,$sqlschool);
                            while ($rowschool=mysqli_fetch_array($resschool)){
                        ?>
                        <option class="text-left" value="<?php echo $rowschool['IDTruong']; ?>"><?php echo $rowschool['Tentruong']; ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="col-md-3 d-flex justify-content-center">
                    ...
                    <?php while($rowin=mysqli_fetch_array($resin)){ ?>
                        <option class="text-left" value="<?php echo $rowin['Tentiengviet']; ?>"><?php echo  $rowin['Tentiengviet']; ?></option>
                    <?php } ?>
                    </select>
                </div>
                <div class="col-md-3 d-flex justify-content-center">
    ...
    <?php
        if (isset($_POST['fillsearchBtn'])){
            ...
            $selectedSchool = $_POST['nameSchool'];
            $selectedIndustry = $_POST['industry'];
            $selectedStatus = $_POST['status'];
            $selectedTime = $_POST['time'];

            $sqlsearch = "SELECT emp.Avatar,emp.NameCompany, tin.MucLuong,tin.Nganh,tin.LoaiCV,tin.Diadiem, school.IDTruong,hs.*
                            FROM hosotuyendung hs
                            JOIN nhatuyendung emp ON emp.IDEmployer=hs.IDEmployer
                            JOIN tintuyendung tin ON tin.IDTin=hs.IDTin
                            JOIN ungvien uv ON uv.IDUngvien=hs.IDUngvien
                            JOIN truongdaihoc school ON school.IDTruong=uv.IDTruong
                            WHERE hs.IDEmployer='".$_SESSION['id_employer']."'";
            ...
            if (!empty($selectedSchool)) {
                $sqlsearch .= " AND uv.IDTruong LIKE '%$selectedSchool%'";
            }
                            ...
                            <div id="item" class="col-sm-12" style="height:250px;">
                                ...
                                <div class="d-flex flex-row justify-content-end position-absolute" style="bottom:-50px;left:0;right:0px;">
                                    ...
                                    ?>
                                        ...
                                        <?php } ?>
                                    <a href="/Employer/home/danh-sach-don-ung-tuyen/thong-tin-chi-tiet/<?php echo $rowsearch['IDHoSo']; ?>" class="btn btn-primary" style="border-radius:40px;">Chi tiết</a>                                </div>
                            </div>
                        </div>
                    </div>
                </div>  
                            ...
                            <div id="item" class="col-sm-12" style="height:250px;">
                                ...
                                <div class="d-flex flex-row justify-content-end position-absolute" style="bottom:-50px;left:0;right:0px;">
                                    ...
                                    ?>
                                        ...
                                        <?php } ?>
                                    <a href="/Employer/home/danh-sach-don-ung-tuyen/thong-tin-chi-tiet/<?php echo $row['IDHoSo']; ?>" class="btn btn-primary" style="border-radius:40px;">Chi tiết</a>
                                </div>
                            </div>
                        </div>
                    </div>
