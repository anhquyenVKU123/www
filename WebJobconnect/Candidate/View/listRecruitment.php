...
<body>
    ...
    <div class="container-fluid d-flex align-content-center justify-content-center">
        <div id="containerForm">
            <form action="/Candidate/home/danh-sach-tin-tuyen-dung" method="post" id="formsearch">
    ...
    <div class="container-fluid d-flex align-content-center justify-content-center py-2">
        <form action="/Candidate/home/danh-sach-tin-tuyen-dung" id="bolocForm" method="POST">
            <div class="row">
                        ...
                        <div class="p-2" style="width:100%;">
                            ...
                            <div id="item" class="col-sm-12" style="height:150px;">
                                ...
                                <div class="d-flex flex-row justify-content-end position-absolute" style="bottom:-50px;left:0;right:0px;">
                                    ...
                                    <a href="/Candidate/home/danh-sach-tin-tuyen-dung/thong-tin-chi-tiet/<?php echo $rowsearch['IDTin']; ?>" class="btn btn-success">Xem</a>
                                    <a href="/Candidate/home/don-ung-tuyen/<?php echo $rowsearch['IDTin']; ?>" class="btn btn-primary mx-1">Ứng tuyển</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-2" style="width:100%;">
                            ...
                            <div id="item" class="col-sm-12" style="height:150px;">
                                ...
                                <div class="d-flex flex-row justify-content-end position-absolute" style="bottom:-50px;left:0;right:0px;">
                                    ...
                                    <a href="/Candidate/home/danh-sach-tin-tuyen-dung/thong-tin-chi-tiet/<?php echo $row['IDTin']; ?>" class="btn btn-success">Xem</a>
                                    <a href="/Candidate/home/don-ung-tuyen/<?php echo $row['IDTin']; ?>" class="btn btn-primary mx-1">Ứng tuyển</a>
                                </div>
                            </div>
                        </div>
                    </div>
