...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a href="/Candidate/home" class="btn text-white">Trang chủ</a>
                        <i class="fas fa-angle-right text-white"></i>
                        <a href="/Candidate/home/danh-sach-nganh-linh-vuc" class="btn text-white">Danh sách ngành/lĩnh vực</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid d-flex align-content-center justify-content-center">
        <div id="containerForm">
            <form action="/Candidate/home/danh-sach-nganh-linh-vuc" method="post" id="formsearch">
                ...
                <div class="card my-5 border border-primary" style="width:18rem; height:450px;border-radius:20px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-content-center justify-content-center">
                            <a href="/Candidate/home/danh-sach-nganh-linh-vuc/thong-tin-chi-tiet/<?php echo $rowsearch['IDNganh']; ?>" class="btn btn-primary mx-2 p-2 flex-grow-1 rounded-pill">Thông tin chi tiết</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3 d-flex align-content-center justify-content-center">
                <div class="card my-5 border border-primary" style="width:18rem; height:450px;border-radius:20px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Mã Ngành: <?php echo $row['IDNganh']; ?></h5>
                        <p class="card-text text-danger font-italic font-weight-medium"><?php echo $row['Tentiengviet']; ?></p>
                        <p class="card-text text-info font-italic font-weight-medium"><?php echo $row['Tentienganh']; ?></p>
                        <div class="d-flex align-content-center justify-content-center">
                            <a href="/Candidate/home/danh-sach-nganh-linh-vuc/thong-tin-chi-tiet/<?php echo $row['IDNganh']; ?>" class="btn btn-primary mx-2 p-2 flex-grow-1 rounded-pill">Thông tin chi tiết</a>
                        </div>
                    </div>
                </div>
            </div>
