...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn text-white" href="/Candidate/home/danh-sach-tin-tuyen-dung">Danh sách tin tuyển dụng</a>
                        <i class="fas fa-angle-right text-white"></i>
    ...
    <div class="container-fluid">
        <?php 
            $sqlcom = "SELECT*FROM binhluantintuyendung WHERE IDUngvien='".$_SESSION['id_candidate']."' AND IDTin='".$_GET['IDRec']."'";
            $rescom = mysqli_query($conn,$sqlcom);
            while ($rowcom=(mysqli_fetch_array($rescom))) {
                $sqluv = "SELECT*FROM ungvien WHERE IDUngvien='".$_SESSION['id_candidate']."'";
                $resuv = mysqli_query($conn,$sqluv);
                $rowuv=mysqli_fetch_array($resuv);
        ?>
        <div class="container-fluid row">
            <div class="col-sm-9 col-lg-4 bg-secondary my-3 mx-2" style="border-radius:30px;">
                <div class="p-3">
                    <span>
                ...
                ?>
                <div class="container-fluid row mx-5 my-2">
        ...
        <div class="d-flex-row">
            <span class="mx-5">
                <form action="/Candidate/xu-li-gui-binh-luan-tin-tuyen-dung/<?php echo $_GET['IDRec']; ?>" method="get">
                    <textarea type="text" name="comments" id="comment" placeholder="Gửi bình luận"></textarea>
                    <button type="submit" class="btn btn-outline-primary px-3 my-3">Gửi</button>
                </form>
            </span>
            <button class="btn btn-outline-dark" id="btncomment">Tất cả bình luận >></button>
        </div>
    </div>
    <script>
        ClassicEditor
