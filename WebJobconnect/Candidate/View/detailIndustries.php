...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn text-white" href="/Candidate/home/danh-sach-nganh-linh-vuc">Ngành/Lĩnh vực</a>
                        <i class="fas fa-angle-right text-white"></i>
                        <a class="btn text-white" href="/Candidate/home/danh-sach-nganh-linh-vuc/thong-tin-chi-tiet/<?php echo $row['IDNganh']; ?>"><?php echo $row['Tentiengviet']; ?></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="d-sm-flex my-3 mx-5">
        ...
        <div class="flex-grow-1 ms-3 mx-5">
            ...
            <div class="my-3">
                <a href="/Candidate/home/danh-sach-tin-tuyen-dung/thong-tin-chi-tiet/<?php echo $rowtin['IDTin']; ?>" class="text-decoration-none"><?php echo $rowtin['TenTin']; ?></a>
            </div>
            <?php } ?>
        </div>
    </div>
