...
<head>
    ...
    <link rel="stylesheet" href="/WebJobconnect/Candidate/css/avatar.css">
</head>
<body>
    <!-- Topbar Start -->
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn text-white" href="/Candidate/home/danh-sach-ung-vien">Danh sách ứng viên</a>
                        <i class="fas fa-angle-right text-white"></i>
            ...
            <div class="col-md-3">
                <div id="detail" class="d-sm-flex my-3 mx-5">
                    <div class="flex-grow-1 ms-3 mx-5 float-md-right">
                        <span style="font-weight:bold;color:black;border-bottom:3px solid #dc3545;">Hình ảnh</span>
                        <div id="avatar">
                            <?php if ($row['Avatar'] != "") {?>
                                <img src="/WebJobconnect/Candidate/image/<?php echo $row['Avatar']; ?>" alt="Ảnh đại diện" style="width:300px;height:400px;border-radius:20px;">
                            <?php } else echo 'Chưa có ảnh đại diện'; ?>
                        </div>
                        <?php if( $_GET['IDCandi'] == $_SESSION['id_candidate'])  {?>
                        <div class="d-inline">
                            <form action="/Candidate/them-anh-dai-dien" method="post" enctype="multipart/form-data">                              
    ...
    <div class="container-fluid">
        <div class="d-flex flex-row row">         
            <?php
                if( $_GET['IDCandi'] == $_SESSION['id_candidate'])  {
    ...
    <div class="container1" id="signupStudent"> 
      <form class="form" action="/Candidate/xu-li-cap-nhat" method="get">
          <div class="input-box">
          ...
          <div class="input-box address">
            ...
            <div class="select-box">
                <select name="industry">
                    <option hidden="">Ngành học</option>
                    <?php
