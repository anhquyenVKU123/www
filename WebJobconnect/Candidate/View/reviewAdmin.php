<?php
    ...
    $sql = "SELECT*FROM ungvien WHERE IDUngvien='".$_SESSION['id_candidate']."'";
...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn text-white disabled" href="">Tương tác - Quản trị viên</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <?php 
            $sqlcom = "SELECT*FROM binhluanqtv WHERE IDUser='".$_SESSION['id_candidate']."'";
        ...
        <div class="container-fluid row">
            <div class="col-sm-9 col-lg-4 bg-secondary my-3" style="border-radius:30px;">
                <div class="p-3">
                    <span>
                        <img src="/WebJobconnect/Candidate/image/<?php echo $row['Avatar']; ?>" alt="" style="border-radius:50%;width:60px;height:60px;">
                        <span class="text-dark font-italic font-weight-medium"><?php echo $row['Hovaten']; ?></span>
        ...
        <div class="d-flex-row">
            <span class="mx-5">
                <form action="/Candidate/xu-li-gui-binh-luan" method="get">
