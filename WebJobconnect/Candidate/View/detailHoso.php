...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn text-white" href="home.php">Trang chủ</a>
                        <i class="fas fa-angle-right text-white"></i>
                        <a class="btn text-white" href="/Candidate/home/danh-sach-don-ung-tuyen">Danh sách đơn ứng tuyển</a>
                        <i class="fas fa-angle-right text-white"></i>
    ...
    <div class="container-fluid bg-primary" style="width:100%;height:auto;margin-top:-100px;">
        <div class="d-flex align-content-center justify-content-center">
            <div class="text-white text-uppercase my-3" style="font-size:40px;"><?php echo $row['Tenhoso']; ?></div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-md-12">
                <button href=""  class="btn btn-success" id="btnUpdateForm">Cập nhật</button>
            </div>
        </div>
    </div>
    
    <!-- Form cập nhật đơn ứng tuyển -->
    <div class="container1" id="update" style="display:none;"> 
      <form class="form" action="/Candidate/xu-li-cap-nhat-don" method="get" onsubmit="updateHiddenInput()">
          <div class="input-box">
              <label>Tên đơn ứng tuyển <span class="text-danger">(*)</span></label>
              <input name="name" required="" type="text" value="<?php echo $row['Tenhoso']; ?>">
          </div>
          <div class="column"> 
            <div class="input-box address">
              ...
              <div class="input-box">
                ...
                <input name="position" required="" type="text" value="<?php echo $row['Vitriungtuyen']; ?>">
              </div>
          </div>
          <div class="input-box">
              <label>Kỹ năng<span class="text-danger">(*)</span></label>
              <textarea name="softskills" id="softskills">
                <?php echo $row['Kynangmem']; ?>
              </textarea>
          </div>
          <div class="input-box">
              <label>Bằng cấp/ chứng chỉ liên quan(nếu có)<span class="text-danger">(*)</span></label>
              <textarea name="proskills" id="proskills">
                <?php echo $row['Kynangchuyenmon']; ?>
              </textarea>
          </div>
          <div class="input-box">
...
<script>
    ...
    var button = document.getElementById("btnUpdateForm");
