...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn text-white disabled" href="">Tương tác - Nhà tuyển dụng</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <?php 
            $sqlcom = "SELECT*FROM binhluanqtv WHERE Vaitro='Nhà tuyển dụng'";
            $rescom = mysqli_query($conn,$sqlcom);
            while ($rowcom=(mysqli_fetch_array($rescom))) {
                $sqlemp = "SELECT*FROM nhatuyendung WHERE IDEmployer='".$rowcom['IDUser']."'";
        ...
        <div class="container-fluid row">
            <div class="col-sm-9 col-lg-4 bg-secondary my-3" style="border-radius:30px;">
                <div class="p-3">
                    <span>
                        <img src="/WebJobconnect/Candidate/image/<?php echo $rowemp['Avatar']; ?>" alt="" style="border-radius:50%;width:60px;height:60px;">
        ...
        <div class="d-flex-row">
            <span class="mx-5">
                <form action="/Admin/home/xu-li-phan-hoi-nha-tuyen-dung/<?php echo $rowcom['IDComment']; ?>" method="get" id="myForm">
