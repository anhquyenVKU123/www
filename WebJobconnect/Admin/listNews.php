        ...
        <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    ...
                    <a href="/Admin/home/dang-tin-tuc" class="btn btn-primary mx-5 my-3 p-2 rounded-pill">Đăng tin tức</a>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn text-white" href="/Admin/home">Trang chủ</a>
                        <i class="fas fa-angle-right text-white"></i>
                        <a class="btn text-white" href="/Admin/home/danh-sach-tin-tuc">Danh sách tin tức</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="bg-light mb-4 w-100 h-100 shadow border border-primary">
                            <div class="position-relative">
                                ...
                                <a href="/Admin/home/danh-sach-tin-tuc/noi-dung/<?php echo $row['IDNews']; ?>" class="position-absolute w-100 h-100 d-flex flex-column align-items-center justify-content-center   text-decoration-none p-4" style="top: 0; left: 0; background: rgba(0, 0, 0, .4);">
                                ...
                                <script>
                                    function confirmDelete(id){
                                        if (confirm("Bạn có chắc chắn muốn xóa tin này?")){
                                            window.location.href="/Admin/home/xu-li-xoa-tin-tuc/" + id;
                                        }
                                    }
                                </script>
                                <a href="#" class="btn btn-danger rounded-pill" onclick="confirmDelete('<?php echo $row['IDNews']; ?>')">Xóa</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                        ...
                        <div class="d-flex flex-column pl-3">
                            <a class="text-dark mb-2" href="/Admin/home/danh-sach-tin-tuc/noi-dung/<?php echo $rownews['IDNews']; ?>"><?php echo $rownews['Tieude']; ?></a>
                            <div class="d-flex">
