...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn text-white" href="/Admin/home/danh-sach-nha-tuyen-dung">Nhà tuyển dụng</a>
    ...
    <div class="container-fluid">
        <div class="row d-flex">
            <div class="col-md-12">
                <span style="font-weight:bold;color:black;border-bottom:3px solid #dc3545;margin: 10px 0 10px 95px;">Thông tin chi tiết nhà tuyển dụng</span>
            </div>
        </div>  
        ...
        ?>
            <div id="item" class="col-sm-12">
                ...
                <div class="d-flex flex-row">
                    ...
                    ?></p>
                    <a href="/Admin/home/chi-tiet-tin-tuyen-dung/<?php echo $row['IDTin']; ?>" class="btn btn-success">Xem</a>
                </div>
            </div>
        <?php } ?>
    </div>
