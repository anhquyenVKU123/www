...
<body>
    ...
    ?>
        <div class="d-flex align-items-center justify-content-center">
            <p class="text-primary font-weight-bold">Danh sách này có <?php echo mysqli_num_rows($res); ?> nhà tuyển dụng</p>
        </div>
                ...
                <div class="card my-5 border-primary" style="width:18rem;border:3px solid;border-radius:25px;overflow:hidden;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-content-center justify-content-center">
                            <a href="/Admin/home/danh-sach-nha-tuyen-dung/chi-tiet-nha-tuyen-dung/<?php echo $row['IDEmployer']; ?>" class="btn btn-primary mx-2 p-2 flex-grow-1 rounded-pill">Thông tin chi tiết</a>
                            <script>
                                function confirmDelete(id){
                                if (confirm("Bạn có chắc chắn muốn xóa nhà tuyển dụng này ra khỏi hệ thống?")){
                                    window.location.href="/Admin/home/xu-li-xoa-nha-tuyen-dung/" + id;
                                    }
                                }
                            </script>
                            <a href="#" onclick="confirmDelete('<?php echo $row['IDEmployer']; ?>');" class="btn btn-danger rounded-pill">Xóa</a>
                        </div>
                    </div>
                </div>
            </div>
